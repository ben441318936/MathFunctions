...
public void setup()
{
	...
	*/
	//tests
	println("test 1");  println(" ");   /* change this part only >>*/  LCosNLSin("SSS",1,Math.sqrt(3)/2,0.5,0,0,0);   /*<< change this part only*/   println(" "); 
	println("test 2");  println(" ");   /* change this part only >>*/  LCosNLSin("SAS",1,Math.sqrt(3)/2,0,0,0,30);    /*<< change this part only*/   println(" ");
	println("test 3");  println(" ");   /* change this part only >>*/  LCosNLSin("ASS",1,0,0.5,0,0,30);               /*<< change this part only*/   println(" ");
	println("test 4");  println(" ");   /* change this part only >>*/  LCosNLSin("ASS",1,0,0.5,90,0,0);               /*<< change this part only*/   println(" ");
	println("test 5");  println(" ");   /* change this part only >>*/  LCosNLSin("ASS",0,Math.sqrt(3)/2,0.5,0,0,30);  /*<< change this part only*/   println(" ");
	println("test 6");  println(" ");   /* change this part only >>*/  LCosNLSin("ASS",0,Math.sqrt(3)/2,0.5,0,60,0);  /*<< change this part only*/   println(" ");
	...
	println("test 13"); println(" ");   /* change this part only >>*/  LCosNLSin("AAS",0,0,0.5,90,0,30);              /*<< change this part only*/   println(" ");
	println("test 14"); println(" ");   /* change this part only >>*/  LCosNLSin("AAS",0,0,0.5,0,60,30);              /*<< change this part only*/   println(" ");
	...
	println("test 17"); println(" ");   /* change this part only >>*/  LCosNLSin("ASA",0,0,0.5,90,60,0);              /*<< change this part only*/   println(" ");
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	if(type.equals("SSS"))
	{
		...
		angleA=Math.toDegrees(Math.acos((Math.pow(sidea,2)-Math.pow(sideb,2)-Math.pow(sidec,2))/(-2.0*sideb*sidec)));
		angleB=Math.toDegrees(Math.acos((Math.pow(sideb,2)-Math.pow(sidea,2)-Math.pow(sidec,2))/(-2.0*sidea*sidec)));
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	if(type.equals("SAS"))
	{
		if(a==0)
		{
			...
			angleC=Math.toDegrees(Math.acos((Math.pow(sidec,2)-Math.pow(sideb,2)-Math.pow(sidea,2))/(-2.0*sideb*sidea)));
			angleB=Math.toDegrees(Math.acos((Math.pow(sideb,2)-Math.pow(sidea,2)-Math.pow(sidec,2))/(-2.0*sidea*sidec)));
			area=sidec*sidea*Math.sin(Math.toRadians(angleB))/2;
			println("side a: "+String.format("%.3f",sidea));   println("side b: "+String.format("%.3f",sideb));   println("side c: "+String.format("%.3f",sidec));
			println("angle A: "+String.format("%.3f",angleA)); println("angle B: "+String.format("%.3f",angleB)); println("angle C: "+String.format("%.3f",angleC));
		...
		if(c==0)
		{
			...
			angleB=Math.toDegrees(Math.acos((Math.pow(sideb,2)-Math.pow(sidec,2)-Math.pow(sidea,2))/(-2.0*sidec*sidea)));
			angleA=Math.toDegrees(Math.acos((Math.pow(sidea,2)-Math.pow(sideb,2)-Math.pow(sidec,2))/(-2.0*sideb*sidec)));
			area=sidec*sidea*Math.sin(Math.toRadians(angleB))/2;
			println("side a: "+String.format("%.3f",sidea));   println("side b: "+String.format("%.3f",sideb));   println("side c: "+String.format("%.3f",sidec));
			println("angle A: "+String.format("%.3f",angleA)); println("angle B: "+String.format("%.3f",angleB)); println("angle C: "+String.format("%.3f",angleC));
	...
	if(type.equals("ASS") || type.equals("SSA"))
	{
		...
		if(a==0)
		{
			...
			if(B==0)
			{
				...
				angleB1=Math.toDegrees(Math.acos((Math.pow(sideb,2)-Math.pow(sidea1,2)-Math.pow(sidec,2))/(-2.0*sidea1*sidec)));
				angleA1=Math.toDegrees(Math.acos((Math.pow(sidea1,2)-Math.pow(sidec,2)-Math.pow(sideb,2))/(-2.0*sideb*sidec)));
				...
				angleB2=Math.toDegrees(Math.acos((Math.pow(sideb,2)-Math.pow(sidea2,2)-Math.pow(sidec,2))/(-2.0*sidea2*sidec)));
				angleA2=Math.toDegrees(Math.acos((Math.pow(sidea2,2)-Math.pow(sidec,2)-Math.pow(sideb,2))/(-2.0*sideb*sidec)));
			...
			if(C==0)
			{
				...
				angleC1=Math.toDegrees(Math.acos((Math.pow(sidec,2)-Math.pow(sidea1,2)-Math.pow(sideb,2))/(-2.0*sidea1*sideb)));
				angleA1=Math.toDegrees(Math.acos((Math.pow(sidea1,2)-Math.pow(sidec,2)-Math.pow(sideb,2))/(-2.0*sideb*sidec)));
				...
				angleC2=Math.toDegrees(Math.acos((Math.pow(sidec,2)-Math.pow(sidea2,2)-Math.pow(sideb,2))/(-2.0*sidea2*sideb)));
				angleA2=Math.toDegrees(Math.acos((Math.pow(sidea2,2)-Math.pow(sidec,2)-Math.pow(sideb,2))/(-2.0*sideb*sidec)));
		...
		if(b==0)
		{
			...
			if(A==0)
			{
				...
				angleA1=Math.toDegrees(Math.acos((Math.pow(sidea,2)-Math.pow(sideb1,2)-Math.pow(sidec,2))/(-2.0*sideb1*sidec)));
				angleB1=Math.toDegrees(Math.acos((Math.pow(sideb1,2)-Math.pow(sidea,2)-Math.pow(sidec,2))/(-2.0*sidec*sidea)));
				...
				angleA2=Math.toDegrees(Math.acos((Math.pow(sidea,2)-Math.pow(sideb2,2)-Math.pow(sidec,2))/(-2.0*sideb2*sidec)));
				angleB2=Math.toDegrees(Math.acos((Math.pow(sideb2,2)-Math.pow(sidea,2)-Math.pow(sidec,2))/(-2.0*sidec*sidea)));
			...
			if(C==0)
			{
				...
				angleC1=Math.toDegrees(Math.acos((Math.pow(sidec,2)-Math.pow(sideb1,2)-Math.pow(sidea,2))/(-2.0*sideb1*sidea)));
				angleB1=Math.toDegrees(Math.acos((Math.pow(sideb1,2)-Math.pow(sidea,2)-Math.pow(sidec,2))/(-2.0*sidec*sidea)));
				...
				angleC2=Math.toDegrees(Math.acos((Math.pow(sidec,2)-Math.pow(sideb2,2)-Math.pow(sidea,2))/(-2.0*sideb2*sidea)));
				angleB2=Math.toDegrees(Math.acos((Math.pow(sideb2,2)-Math.pow(sidea,2)-Math.pow(sidec,2))/(-2.0*sidec*sidea)));
		...
		if(c==0)
		{
			...
			if(B==0)
			{
				...
				angleB1=Math.toDegrees(Math.acos((Math.pow(sideb,2)-Math.pow(sidea,2)-Math.pow(sidec1,2))/(-2.0*sidea*sidec1)));
				angleC1=Math.toDegrees(Math.acos((Math.pow(sidec1,2)-Math.pow(sidea,2)-Math.pow(sideb,2))/(-2.0*sideb*sidea)));
				...
				angleB2=Math.toDegrees(Math.acos((Math.pow(sideb,2)-Math.pow(sidea,2)-Math.pow(sidec2,2))/(-2.0*sidea*sidec2)));
				angleC2=Math.toDegrees(Math.acos((Math.pow(sidec2,2)-Math.pow(sidea,2)-Math.pow(sideb,2))/(-2.0*sideb*sidea)));
			...
			if(A==0)
			{
				...
				angleA1=Math.toDegrees(Math.acos((Math.pow(sidea,2)-Math.pow(sideb,2)-Math.pow(sidec1,2))/(-2.0*sideb*sidec1)));
				angleC1=Math.toDegrees(Math.acos((Math.pow(sidec1,2)-Math.pow(sidea,2)-Math.pow(sideb,2))/(-2.0*sideb*sidea)));
				...
				angleA2=Math.toDegrees(Math.acos((Math.pow(sidea,2)-Math.pow(sideb,2)-Math.pow(sidec2,2))/(-2.0*sideb*sidec2)));
				angleC2=Math.toDegrees(Math.acos((Math.pow(sidec2,2)-Math.pow(sidea,2)-Math.pow(sideb,2))/(-2.0*sideb*sidea)));
